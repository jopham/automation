...
auto_log = open(logName, 'w')
auto_log.write('*****************************************************************************************\n')
auto_log.write('*****************************************************************************************\n')
auto_log.write('\n')
auto_log.write("~ Let the automation begin! ~\n")
auto_log.write('\n')
auto_log.write('*****************************************************************************************\n')
auto_log.write('*****************************************************************************************\n')
...
auto_log.write('Start time: ' + str(dt) + '\n\n')
auto_log.write(str(datetime.datetime.now()) + ' INFO: Unique output folder name is ' + outputName + '\n')
...
if not os.path.exists(os.path.dirname(folder)):
    try:
        auto_log.write(str(datetime.datetime.now()) + ' INFO: Create ' + folder + '\n')
        os.makedirs(os.path.dirname(folder))
        auto_log.write(str(datetime.datetime.now()) + ' INFO: Create ' + folder + 'dataFiles/\n')
        os.makedirs(os.path.dirname(folder+'dataFiles/'))
    except:
        auto_log.write(str(datetime.datetime.now()) + ' ERROR: Creating a folder in the ' + folder + '\n')
...
if not os.path.exists(os.path.dirname(folder)):
    try:
        ...
        auto_log.write(str(datetime.datetime.now()) + ' ERROR: Creating ' + folder + '\n')
